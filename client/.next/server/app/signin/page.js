...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6950)), "D:\\JobPrePro\\client\\src\\app\\signin\\page.js"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5468)), "D:\\JobPrePro\\client\\src\\app\\layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["D:\\JobPrePro\\client\\src\\app\\signin\\page.js"];
...
function page() {
    ...
    async function register() {
        try {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.post("/auth/register", user).then((res)=>{
    ...
    async function login() {
        try {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.post("/auth/login", user).then((res)=>{
                setcall_again_getuser(!call_again_getuser);
            });
        } catch (err) {
            console.error(err);
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                className: "password-req",
                                style: {
                                    fontSize: "8px",
                                    margin: "0%",
                                    padding: "0%"
                                },
                                children: "*Minimum eight and maximum 10 characters"
                            }),
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`D:\JobPrePro\client\src\app\signin\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [669,686,839], () => (__webpack_exec__(5169)));
